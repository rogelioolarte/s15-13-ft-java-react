    ...
    <>
      ...
      <div className='w-full flex flex-col lg:flex-row items-center lg:justify-between gap-2'>
        ...
        <div className='flex flex-wrap items-center gap-2'>
          ...
          <Button disabled={selectedItems.length < 1} onClick={() => setIsDeleteConfirmationOpen(true)} className='min-w-fit flex-1 bg-warning-40 text-gray-900 shadow-none hover:shadow-none hover:bg-indigo-100 transition-all duration-300 ease-in-out'>Delete</Button>
        </div>
      </div>
    </>
  )
