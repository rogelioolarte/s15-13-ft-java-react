...
export default function ProductsHeader ({ onSearch, selectedItems, setIsDeleteConfirmationOpen }) {
  return (
    <>
      ...
      <div className='w-full flex flex-col lg:flex-row items-center lg:justify-between gap-2'>
        ...
        <div className='flex flex-wrap items-center gap-2'>
          <FormModal button={<Button className='min-w-fit flex-1 bg-warning text-gray-900 shadow-none hover:shadow-none hover:bg-warning-80 transition-all duration-300 ease-in-out'>Add New</Button>} action='create' formType='Product' />
